package com.harms.bitbucket.plugin.jenkins.job.settings.upgrade.steps;
...
public class Upgrade_1_0_1 implements Upgrade {
    ...
    private static final String PLUGIN_STORAGE_KEY = "bitbucket.plugin.jenkins.settingsui";
