 ...
 *
 */
public class ScheduledJobTriggerInfoServlet extends JenkinsBitbucketBaseServlet {
    ...
    public ScheduledJobTriggerInfoServlet(LoginUriProvider loginUriProvider, AuthenticationContext authContext) {
