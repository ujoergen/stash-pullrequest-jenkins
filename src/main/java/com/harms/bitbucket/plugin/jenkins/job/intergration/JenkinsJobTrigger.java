...
final public class JenkinsJobTrigger implements JobTrigger {
	...
	/* (non-Javadoc)
     * @see com.harms.bitbucket.plugin.jenkins.job.intergration.TriggerJobIntergration#nextCIServer(java.lang.String)
     */
	@Override
	...
	/* (non-Javadoc)
     * @see com.harms.bitbucket.plugin.jenkins.job.intergration.TriggerJobIntergration#validateSettings(java.lang.String, java.lang.String)
     */
	@Override
    ...
    /* (non-Javadoc)
     * @see com.harms.bitbucket.plugin.jenkins.job.intergration.TriggerJobIntergration#triggerBuild(java.lang.Integer, java.lang.String, java.lang.Long, java.lang.String, java.lang.String, com.harms.bitbucket.plugin.jenkins.job.intergration.TriggerRequestEvent, int, java.lang.String)
     */
    @Override
            ...
            if (response != null) {
                ...
                if (statusCode >= 400) {
                    if (!retryTriggerJob(toRefRepositoryId, latestChangeset, pullRequestId, pullRequestTitle, slug, projectKey, eventType, retryCount, url, statusCode, "", fromBranchId, toBranchId)) {
                    	LOG.warn(String.format("Unable to trigger job for PR: %d (%s)", pullRequestId, pullRequestTitle));
