package com.harms.bitbucket.plugin.jenkins.job.settings;
...
import com.harms.bitbucket.plugin.jenkins.job.settings.servlet.ManualTriggerBuildServlet;
...
public class PluginSettingsHelper {
    ...
    public static final String PLUGIN_STORAGE_KEY = "bitbucket.plugin.jenkins.settingsui";
     ...
     * @return "bitbucket.plugin.jenkins.settingsui.<project key>/<slug>/pull-request-id"
     */
    static private String getDisableAutomaticBuildSettingsKey(String projectKey, String slug, Long pullRequestId) {
        return "bitbucket.plugin.jenkins.settingsui." + projectKey + "/" + slug+ "/" + pullRequestId;
    }

    public static String getPluginKey(String baseKey, String slug) {
        return baseKey + slug;
    }
     ...
     */
    public static void clearAutomaticBuildFlag(String projectKey, String slug, Long pullRequestId, PluginSettings settings) {
    	LOG.info(String.format("Enabling automatic builds for PR: %d@%s (%s)", pullRequestId, projectKey, slug));
    ...
    public static void enableAutomaticBuildFlag(String projectKey, String slug, Long pullRequestId, PluginSettings settings) {
    	LOG.info(String.format("Disabling automatic builds for PR: %d@%s (%s)", pullRequestId, projectKey, slug));
     ...
     */
    public static byte[] getPassword(String slug, PluginSettings settings) throws DecryptException {
     ...
     */
    public static void setPassword(String slug,byte[] password, PluginSettings settings) throws EncryptException {
        String key = getPluginKey(JENKINS_PASSWORD, slug);
        try {
     ...
     * @throws DecryptException
     */
    public static byte[] getUsername(String slug, PluginSettings settings) throws DecryptException {
     ...
     * @throws EncryptException
     */
    public static void setUsername(String slug,byte[] username, PluginSettings settings) throws EncryptException {
        String key = getPluginKey(JENKINS_USERNAME, slug);
        try {
