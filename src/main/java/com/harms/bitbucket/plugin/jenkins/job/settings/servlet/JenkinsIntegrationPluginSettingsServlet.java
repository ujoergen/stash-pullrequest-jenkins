...
import com.harms.bitbucket.plugin.jenkins.job.settings.DecryptException;
import com.harms.bitbucket.plugin.jenkins.job.settings.EncryptException;
import com.harms.bitbucket.plugin.jenkins.job.settings.PluginSettingsHelper;
import com.harms.bitbucket.plugin.jenkins.job.settings.upgrade.UpgradeService;
import com.harms.bitbucket.plugin.jenkins.job.settings.upgrade.steps.Upgrade_1_0_1;
import com.harms.bitbucket.plugin.jenkins.job.settings.upgrade.steps.Upgrade_1_0_2;
import com.harms.bitbucket.plugin.jenkins.job.settings.upgrade.steps.Upgrade_1_0_3;
import com.harms.bitbucket.plugin.jenkins.job.settings.upgrade.steps.Upgrade_1_0_5;
import com.harms.bitbucket.plugin.jenkins.job.settings.upgrade.steps.Upgrade_1_0_6;

public class JenkinsIntegrationPluginSettingsServlet extends JenkinsBitbucketBaseServlet {
    ...
    public JenkinsIntegrationPluginSettingsServlet(SoyTemplateRenderer soyTemplateRenderer, RepositoryService repositoryService, PluginSettingsFactory pluginSettingsFactory, AuthenticationContext authContext, LoginUriProvider loginUriProvider) {
    ...
    protected void render(HttpServletResponse resp, Map<String, Object> data) throws IOException, ServletException {
        String template = "bitbucket.config.jenkins.job.integration.repositorySettings";
        resp.setContentType("text/html;charset=UTF-8");
        try {
            soyTemplateRenderer.render(resp.getWriter(),
                    "com.harms.bitbucket.jenkins-integration-plugin:setting-soy",
                    template,
                    data);
